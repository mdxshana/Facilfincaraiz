            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group" style="margin-top: 20px;">
                        ...
                        <div class="col-sm-8">
                            {!!Form::select('id_dpto', $arrayDepartamento, null, ['class'=>"form-control",'placeholder' => 'Seleccione un Departamento', 'required'])!!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            {!!Form::text('geolocalizacion',null,['class'=>'form-control','id'=>'coords','disabled'])!!}
                        </div>
                    </div>
                </div>
